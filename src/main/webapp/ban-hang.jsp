                    ...
                    <table class="table table-bordered text-center align-middle">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="hd" items="${listHoaDonCho}">
                                ...
                                <tr class="${hd.id == sessionScope.idHoaDonSelected ? 'table-primary' : ''}">
                                    <td class="fw-bold">${hd.maHoaDon}</td>
                                    <td>${hd.ngayTao}</td>
                                    <td><span class="badge bg-warning text-dark">Chờ thanh toán</span></td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/ban-hang?action=select&id=${hd.id}" class="btn btn-sm btn-outline-success fw-bold">Chọn</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <table class="table table-bordered text-center align-middle">
                        ...
                        <tbody>
                            <c:choose>
                                <c:when test="${empty listGioHang}">
                                    <tr><td colspan="5" class="text-muted">Chưa có sản phẩm nào trong giỏ.</td></tr>
                                </c:when>
                                <c:otherwise>
                                    <c:forEach var="item" items="${listGioHang}">
                                        <tr>
                                            ...
                                            <td>${item.donGia}</td>
                                            <td class="text-danger fw-bold">${item.soLuong * item.donGia}</td>
                        ...
                        <tbody>
                            <c:forEach var="spct" items="${listSPCT}">
                                <tr>
                                    ...
                                    <td class="fw-bold">${spct.tenSanPham}</td>
                                    <td class="text-danger fw-bold">${spct.donGia}</td>
                                    <td>
                                        
                                        <a href="${pageContext.request.contextPath}/ban-hang?action=add&idSpct=${spct.id}&gia=${spct.donGia}" class="btn btn-sm btn-outline-primary fw-bold ${sessionScope.idHoaDonSelected == null ? 'disabled' : ''}">Thêm</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="card-body p-4">
                    ...
                    <form>
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="text-danger fw-bold fs-5">${hoaDonDangChon != null ? hoaDonDangChon.tongTien : '0'} VNĐ</span>
                        </div>
                        <div class="mb-3">
                        ...
                        <a href="${pageContext.request.contextPath}/ban-hang?action=pay" 
                           class="btn btn-success w-100 fw-bold fs-5 py-2 ${sessionScope.idHoaDonSelected == null ? 'disabled' : ''}"
